...
export function ReportsPageClientContent({ initialCategoryData, errorLoading }: ReportsPageClientContentProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 self-start">
              {categoryData.sort((a,b) => b.amount - a.amount).map((category, index) => (
                // Note: Using background colors directly might have contrast issues.
                // Consider using border colors or icons instead for better accessibility.
                <Card key={category.category}>
                  ...
                  <CardContent className="px-4 pb-3">
                    <div className="text-xl font-bold">{category.amount.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })}</div>
